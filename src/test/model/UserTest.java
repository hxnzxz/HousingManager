...
class UserTest {
    ...
    void testBetterAppointment(){
        assertEquals(testAppointment.cheaper(testAppointment2),testAppointment2.cheaper(testAppointment));
        assertEquals(testAppointment2,testAppointment2.closer(testAppointment));
    }
